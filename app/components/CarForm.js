    ...
    <div class="mb-3">
      <div>
        ...
        <input type="url" class="form-control" name="img" id="img" aria-describedby="img"
          placeholder="Image Url..." required values=${car.imgUrl}>
      </div>
    </div>
    <div class="mb-3">
      <div>
        ...
        <textarea type="text" class="form-control" name="description" id="description"
          aria-describedby="description" placeholder="Description..." min="5" max="250" required values=${car.description}> </textarea>
      </div>
    </div>
